...
<div className="w-48 h-48 mx-auto mb-8 relative">
       <motion.div
        ...
        <motion.div
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ delay: 0.4, duration: 0.8 }}
          className="text-base sm:text-2xl text-slate-300 mb-6 h-6"
        >
          {text}
          <motion.span
            animate={{ opacity: [1, 0] }}
        ...
        <motion.p
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ delay: 0.6, duration: 0.8 }}
          className="text-sm sm:text-lg text-slate-400 mb-8 max-w-2xl mx-auto"
        >
          Passionate about creating beautiful, functional, and user-centered digital experiences.
          I bring ideas to life through code and design.
        </motion.p>
        ...
        >
          {socialLinks.map((link, index) => (
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 bg-slate-800/40 backdrop-blur-md border border-white/10 rounded-full hover:bg-slate-700/50 transition duration-300"
        ...
        <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-3 mb-8">
          {skills.map((skill, idx) => (
            <motion.div
              ...
              style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)' }} // 5% white background
              whileHover={{ y: -3 }}
              whileTap={{
                scale: 0.95,
                backgroundColor: "rgba(200, 200, 255, 0.15)", // Slightly more visible flash
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{
              scale: 0.95,
              backgroundColor: "rgba(96, 165, 250, 0.4)", // blue-400 with opacity for bordered button
              transition: { duration: 0.1 }
            }}
          >
            Get In Touch
